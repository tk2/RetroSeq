...
$t = Utilities::testBreakPoint(10,56902335,'/lustre/scratch102/user/tk2/RetroSeq/Human/NA18506.raw.bam',20,qq[10	56902376	56902359	Alu	10],$dfh);
isa_ok( $t, 'ARRAY' );
foreach( @{$t} ){print qq[$_\n];}

$t = Utilities::testBreakPoint(15,94819895,'/lustre/scratch102/user/tk2/RetroSeq/Human/NA18506.raw.bam',20,qq[15	94818895	94820895	Alu	10],$dfh);
isa_ok( $t, 'ARRAY' );
foreach( @{$t} ){print qq[$_\n];}

$t = Utilities::testBreakPoint(16,82912110,'/lustre/scratch102/user/tk2/RetroSeq/Human/NA18506.raw.bam',20,qq[16	82911110	82913110	Alu	10],$dfh);
isa_ok( $t, 'ARRAY' );
foreach( @{$t} ){print qq[$_\n];}

$t = Utilities::testBreakPoint(2,74125457,'/lustre/scratch102/user/tk2/RetroSeq/Human/NA18506.raw.bam',20,qq[2	74124457	74126457	Alu	10],$dfh);
isa_ok( $t, 'ARRAY' );
foreach( @{$t} ){print qq[$_\n];}
